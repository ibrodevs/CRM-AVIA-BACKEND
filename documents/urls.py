...
urlpatterns = [
    ...
    path(
        "documents/<uuid:document_id>/versions/", v.DocumentVersionsView.as_view(), name="document-versions"
    ),
    path(
        "documents/<uuid:document_id>/generate/", v.DocumentGenerateView.as_view(), name="document-generate"
    ),
    path("documents/<uuid:document_id>/sign/", v.DocumentSignView.as_view(), name="document-sign"),
    ...
    path(
        "receipt-imports/<uuid:import_id>/result/",
        v.ReceiptImportResultView.as_view(),
        name="receipt-import-result",
    ),
    path(
        "receipt-imports/<uuid:import_id>/confirm/",
        v.ReceiptImportConfirmView.as_view(),
