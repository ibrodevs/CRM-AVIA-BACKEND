...
urlpatterns = [
    ...
    path(
        "shifts/<uuid:shift_id>/preview-close/", v.ShiftPreviewCloseView.as_view(), name="shift-preview-close"
    ),
    ...
    path("motivation/accruals/", v.MotivationAccrualsView.as_view(), name="motivation-accruals"),
]
