...
class UserAvatarView(APIView):
    ...
    Право `users.manage` здесь не требуется: аватары нужны в чатах и в списке
    операторов на дашборде, где у обычного оператора этого права нет, и вместо
    фото коллеги он видел инициалы. Фото сотрудника не является чувствительными
    данными; выдача ограничена своим tenant (`_get_user_or_404`).
    """
