...
urlpatterns = [
    ...
    path("calendar/events/check-duplicate/", v.CalendarEventCheckDuplicateView.as_view(),
         name="calendar-check-duplicate"),
    path("calendar/events/<uuid:event_id>/complete/", v.CalendarEventCompleteView.as_view(),
         name="calendar-event-complete"),
    path("calendar/events/<uuid:event_id>/reschedule/", v.CalendarEventRescheduleView.as_view(),
