...
urlpatterns = [
    ...
    path("persons/<uuid:person_id>/documents/", v.PersonDocumentsView.as_view(),
         name="person-documents"),
    path("persons/<uuid:person_id>/loyalty-cards/", v.PersonLoyaltyCardsView.as_view(),
    ...
    path("companies/<uuid:company_id>/employees/", v.CompanyEmployeesView.as_view(),
         name="company-employees"),
    path("companies/<uuid:company_id>/departments/", v.CompanyDepartmentsView.as_view(),
         name="company-departments"),
    path("companies/<uuid:company_id>/contracts/", v.CompanyContractsView.as_view(),
         name="company-contracts"),
    path("contracts/<uuid:contract_id>/agreements/", v.ContractAgreementsView.as_view(),
         name="contract-agreements"),
    path("companies/<uuid:company_id>/settlement/", v.CompanySettlementView.as_view(),
